  ...
  items: [
    {
      ...
      href: "https://github.com/real-stanyan/Mr-Otto/releases/download/v1.0.4/Mr.Otto-1.0.4-arm64.dmg",
    },
    {
      os: "Windows",
      icon: "windows",
      note: "Windows 10 及以上 · x64 · .exe",
      href: "https://github.com/real-stanyan/Mr-Otto/releases/download/v1.0.4/Mr.Otto-1.0.4-win-x64-setup.exe",
    },
  ],
  pending: "即将开放",
