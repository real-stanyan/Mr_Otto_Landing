...
/* wrapEffect 的推断 props 是 Partial<unknown>，自定义 uniform 属性要显式收窄，
   否则 colorNum / pixelSize 过不了类型检查。 */
...
const RetroEffect = forwardRef<RetroEffectImpl, RetroEffectProps>((props, ref) => {
  ...
  const WrappedRetroEffect = wrapEffect(RetroEffectImpl) as unknown as React.ForwardRefExoticComponent<
    React.RefAttributes<RetroEffectImpl> & RetroEffectProps
  >;
  ...
  return (
    ...
    >
      <DitheredWaves
        ...
        colorNum={colorNum}
        pixelSize={pixelSize}
        disableAnimation={disableAnimation || reduced}
